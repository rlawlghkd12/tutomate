...
|---|---|---|
| 16GB+ | 5GB+ | ok (쾌적) |
| 8GB | 3GB+ | ok ("응답 10~20초 걸릴 수 있어요" 안내) |
| 4~7GB | 3GB+ | warn ("성능이 낮거나 매우 느릴 수 있습니다, 그래도 사용?") |
| <4GB | <2GB | block (챗봇 비활성, **직접 임포트 폴백**만 노출) |
...
- **호스팅**: Hugging Face 직접 다운로드 (Qwen2.5-3B-Instruct GGUF Q4_K_M)
- **저장**: Electron `userData/AI/qwen-2.5-3b-instruct-q4.gguf`
