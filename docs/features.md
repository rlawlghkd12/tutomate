...
### 9.3 필터
- [ ] 기간 필터: RangePicker + 빠른 선택 (전체, 이번 달, 지난 달, 올해)
- [ ] 결제 상태 필터: 다중 선택 + 빠른 선택 (전체, 미납만, 미완납, 완납만)
...
### 11.4 라이선스
- [ ] 라이선스 탭: 현재 플랜 정보
- [ ] 키 형식: `TMKH-XXXX-XXXX-XXXX` (Basic) / `TMHA-XXXX-XXXX-XXXX` (Admin)
...
### 11.5 학원 정보
- [ ] 이름 수정 + 저장
- [ ] 체험판: 이름 필드 disabled, "라이선스 활성화 후 변경 가능"
